...
export const descFix = {
  ...
  金流监督: '满层效果攻击力提升$[0]，普攻伤害提升$[1]，重击伤害提升$[2]，星超导伤害提升$[3]，攻速提升$[4]。',
  ...
  漩流颂歌: '治疗加成提升$[0]；治疗时生命上限提升$[1]，且生命上限超过40000的部分每1000点使场上角色攻击力提升$[2]，至多$[3]，至多3层；触发冻结或星扩散后额外提高75%。',
  凝雪沉心: '队伍中每名冰元素角色使精通提升$[0]点，每名雷元素角色使攻击力提升$[1]，至多4名。<br/>辉映·星烁：改为每名冰或雷元素角色使精通提升$[2]点，星烁反应提升$[3]。',
  群王局戏: '施放战技后获得6秒「棋中法度」：攻击力提升$[0]，精通提升$[1]点，每12秒至多一次；期间重击命中延长6秒。',
  寸心余响: '触发元素反应后12秒内精通提升$[0]点；触发星烁反应后12秒内星烁伤害提升$[1]，后台可触发。',
  ...
  岩峰巡歌: '普通攻击或下落攻击命中敌人后，防御力提高$[0]。该效果叠加至2层或2层的持续时间刷新时，基于装备者的防御力，使队伍中附近所有角色的所有元素伤害加成至多提升$[2]',
  蝶变: '施放战技或爆发时，按顺序循环获得三种效果：暴击伤害提升$[0]，持续10秒；星扩散伤害提升$[1]，持续10秒；恢复$[2]点能量。',
  新枝: '施放战技后12秒内，攻击命中获得「蓊郁」：攻击力提升$[0]，精通提升$[1]点，至多3层，后台可触发。辉映·星烁：改为攻击力提升$[2]，且星烁反应伤害提升$[3]。',
  引火之源: '触发元素反应后12秒内攻击力提升$[0]；触发星烁反应后12秒内星烁伤害提升$[1]，后台可触发。',
  白湖冬羽: '战技命中获得「湖色的哀告」：攻击力提升$[0]，持续8秒，至多3层；3层时星烁伤害的暴击伤害提升$[1]，触发或造成星烁时恢复$[2]点能量，后台可触发。',
  熔猎异端之刃: '施放战技后获得「映落瞳中的初光」：基于移动距离获得$[0]~$[1]攻击力加成，每14秒至多一次，退场时移除。',

  // 双手剑
  狼的末路: '攻击力提高$[0]；【（以下效果在伤害计算时默认不触发）攻击命中生命值低于30%的敌人时，队伍中所有成员的攻击力提高$[1]，持续12秒。】',
  ...
  山王长牙: '元素战技命中敌人后或队伍中附近的角色触发了燃烧或烈绽放反应后，元素战技伤害和元素爆发伤害提升$[0]，持续6秒，至多叠加6层。',
  焚曜千阳: '施放元素战技或元素爆发时，暴击伤害提高$[0]，攻击力提升$[1]，该效果持续6秒，每10秒至多触发一次。 此外，处于夜魂加持状态下时，效果提高75%。',
  金律铸影: '每10秒循环奏响「谐律乐章」：攻击力提升$[0]/精通提升$[1]点/星烁伤害提升$[2]，各持续10秒，后台可触发；触发星烁后额外获得12秒同效果的「复调」，可与原乐章叠加。',
  救赎之斩: '触发元素反应后12秒内精通提升$[0]点；触发星烁反应后12秒内攻击力提升$[1]，后台可触发。',
  ...
  护摩之杖: '生命值提升$[0]。获得$[1]生命值上限的攻击力提升。【（以下效果在伤害计算时默认仅胡桃能触发）生命值低于50%时，进一步获得$[2]生命值上限的攻击力提升。】',
  ...
  戍望谣歌: '触发元素反应后恢复$[0]点能量，每9秒至多一次；触发星烁反应后12秒内攻击力提升$[1]，后台可触发。',
  ...
  白雨心弦: '持有1/2/3层疗护时，生命值上限提升$[0]，施放元素战技，生命之契数值增加，进行治疗时装备者将获得1层疗护，处于3层疗护状态下时，元素爆发的暴击率提升$[1]。',
  星鹫赤羽: '触发扩散反应后的12秒内，攻击力提高$[0]。队伍中存在至少1/2名与装备者元素类型不同的角色时，装备者重击造成的伤害提高$[1]，元素爆发造成的伤害提高$[2]。',
  悬黎千钧: '队伍中每名其他同元素角色使精通提升$[0]点，每名异元素角色使攻击力提升$[1]，共至多3层，同元素效果优先。',
  柔风游弦: '充能效率提升$[0]。战技或元素爆发命中叠一层「纯净者的圣咏」，至多3层；3层时消耗所有并获得「蛇信的死毒」：全队星烁反应伤害提升$[1]，持续12秒，后台可触发。'
}
